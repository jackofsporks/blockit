...
// entities: block/phrase, multi, syntax, token, unarmed??
...
block = {
  token: {
    ...
    siblings: ["value2"]?? // Need to know siblings of block. Example is input tag with type attribute of number then change value to type of address. Have to change other attributes maybe. Maybe just explore siblings if needed.
  },
  // ...
  right: {
    type: "multi",
...
// If select multiple blocks and then delete
// Figure out first block
// Figure out last block
// Where those start and end delete all
// Check all blocks in between?? ... probably yes
// Kills parent block or siblings? Question is for all blocks deleted.
