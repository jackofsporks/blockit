...
export default class BlockitView {
  ...
  subscribe (editor) {
    ...
    input.addEventListener("keydown", this.getContents)
    const inputDisp2 = new Disposable(function(){input.removeEventListener("keydown",this.getContents)})
    subs.add(inputDisp2)
