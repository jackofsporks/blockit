...
export default class Renderer {
    ...
    rdr.finders = { // boundries????!?!? that are finding rules. rule finders by boundry characters
      "html": {
        ...
        "<": function(beforeTrigger, afterTrigger, afterCursor){
          ...
          const data = {action:"editable", type:found.type, block: block, color: "black", blockDeleters: /[<>="]/}
  ...
  deleteBlock(previousBlock){
    // remove text and any extra whitespace
  ...
  deleteOne(e, beforeCursor, afterCursor, fileScope, previousBlock){
    ...
    console.log(e.oldText, previousBlock);
    if (previousBlock.blockDeleters && previousBlock.blockDeleters.test(e.oldText)){
      return this.deleteBlock(previousBlock)
    } else return {color: "purple", block: {}}
  }
  insertMany(e, beforeCursor, afterCursor, fileScope, previousBlock){return {color: "black", block: {}}}
  insertOne(e, beforeCursor, afterCursor, fileScope, previousBlock){return {color: "purple", block: {}}}
  ...
  // make it all async!!!! DON'T LOOK BAAAAACK!!!
  // ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^

  locate(e, beforeCursor, afterCursor, fileScope, previousBlock){
    // BRAINSTROM!!!!!!!
    ...
    return this[action](e, beforeCursor, afterCursor, fileScope, previousBlock)
  }
}
