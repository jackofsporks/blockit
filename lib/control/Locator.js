...
export default class Renderer {
  ...
  move(e, beforeCursor, afterCursor, fileScope, previousBlock){
    ...
    return {color: "purple", block: {}}
  }
  deleteMany(e, beforeCursor, afterCursor, fileScope, previousBlock){return {color: "black", block: {}}}
  deleteOne(e, beforeCursor, afterCursor, fileScope, previousBlock){return {color: "purple", block: {}}}
  ...
  locate(e, beforeCursor, afterCursor, fileScope, previousBlock){
    ...
    console.log(e.type, action, e)
    // return {color: "black", block: {}}
