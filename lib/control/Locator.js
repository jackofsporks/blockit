...
export default class Renderer {
    ...
    rdr.finders = { // boundries????!?!? that are finding rules. rule finders by boundry characters
      "html": {
        ...
        "<": function(beforeTrigger, afterTrigger, afterCursor){
          ...
          // TODO find found.afterCursor to combine to get whole value for validation when moving
  ...
  //   // TODO This seems like a fragile way to update a block
  ...
  // BUG doesn't register move when go to new editor. WHY!?!?!! id:71
  ...
  // QUESTION what happens if comma is deleted --> int x, y, z = 4, 5, 6
