...
export default class HTMLBlocks {
  ...
  // doubleQuotes (beforeTrigger, afterTrigger, afterCursor) {
  //   // search text before to find property
  //   // return object belonging to property
  //   return null
  // }

  closeAngle = (beforeTrigger, afterTrigger, afterCursor) => {
  ...
  openAngle = (beforeTrigger, afterTrigger, afterCursor) => {
    ...
    if (found.type === "tag") found.value = tag
      ...
      block = this._getValue(beforeTrigger, afterTrigger, afterCursor, found)
    }
  ...
  _getValue (beforeTrigger, afterTrigger, afterCursor, found) {
